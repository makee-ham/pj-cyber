...
export default function ProductCard() {
  ...
  return (
    <div className="flex flex-col items-center gap-2 w-auto h-[352px] px-3 py-6 bg-[#F6F6F6] rounded-[9px]">
      ...
      <div className="flex flex-col w-full items-center gap-4">
        <div className="flex flex-col items-center gap-4 w-full">
          <h4 className="text-center text-base font-medium leading-6 line-clamp-2">
            {TEMP_TITLE}
          </h4>
